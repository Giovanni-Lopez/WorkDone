...
<div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form action="" class="mt-4" method="get">
        ...
        <textarea name="publish" id="publics" cols="52" rows="10" class="border border-gray-700 rounded-md bg-gray-200 w-full text-lg p-2 my-2 focus:bg-white placeholder-gray-900" placeholder="Descripcion"></textarea>
        ...
        my-6 hover:bg-indigo-600">Enviar Anuncio</button>
